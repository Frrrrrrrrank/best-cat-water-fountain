...
import { ArrowRight, Droplets, Heart, Calendar, Sparkles, AlertTriangle, FlaskConical, MapPin, Calculator, Brain, TrendingUp, Activity } from "lucide-react";

const Blog = () => {
  const articles = [
    {
      title: "Cat Kidney Disease & Water: How Hydration Prevents CKD by 74%",
      description: "Veterinary research proves proper hydration reduces kidney disease risk by 74%. Learn prevention strategies, early symptoms, and hydration management for CKD cats.",
      href: "/blog/cat-kidney-disease-hydration-prevention",
